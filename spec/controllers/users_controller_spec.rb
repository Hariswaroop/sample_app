...
describe UsersController do
    ...
    describe "for signed-in users" do
      ...
      it "should have element for each user" do
          ...
          User.paginate(:page=>1).each do |user|
              respond.should have_selector('li',:content=>user.name)
          end
      end
  ...
  describe "GET 'show'" do
    ...
    it "should show users microposts" do
      ...
      mp1=Factory(:microposts,:user=>@user,:content=>"Bar qux")
      get :show, :id=>@user
  ...
  describe "follow pages" do
    describe "when not signed-in" do
      it "should protect'following'" do
        get :following, :id=>1
        response.should redirect_to(signed_in)
      end
      it "should protect'follower'" do
        get :followers, :id=>1
        response.should redirect_to(signed_in)
      end
    end
